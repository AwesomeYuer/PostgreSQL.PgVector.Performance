...
public class ChromaMemoryStore : IMemoryStore
{
    ...
    Task IMemoryStore.CreateCollectionAsync(string collectionName, CancellationToken cancellationToken)
    {
        throw new NotImplementedException();
    }
    ...
    Task IMemoryStore.RemoveAsync(string collectionName, string key, CancellationToken cancellationToken)
    {
        throw new NotImplementedException();
    }
}